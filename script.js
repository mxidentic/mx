...
spoti.addEventListener('click', ()=> {
    window.open("https://open.spotify.com/user/31lgtko2pdhvlleigocbosu5sve4?si=9da4700052484429", "_blank")
})

tg.addEventListener('click', ()=> {
    window.open("https://t.me/sleep_mx", "_blank")
})

github.addEventListener('click', ()=> {
    window.open("https://github.com/mxidentic", "_blank")
})
